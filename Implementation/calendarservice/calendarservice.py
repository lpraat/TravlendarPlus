...
from src.queryrepository.data.calendar import DBBase

calendarservice = create_app()
register_blueprints(calendarservice)
...
calendarservice.sending_channel = setup_channel_for_sending()
calendarservice.secret_key = '\x0c|f9\x91%1\xb2\xd2\xdd\xeeM\x15\xa1\xf1\xb09U\xb5Oj&\xe0M'  # generated with os.urandom(24)
