...
class TestGetAllCalendars(TestApp):
    def test_all_calendars_get(self):
        ...
        self.assertEqual(json.loads(response.data)['calendars'][0]['name'], 'Home')
        self.assertEqual(json.loads(response.data)['calendars'][1]['name'], 'Job')
